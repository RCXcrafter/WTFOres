...
public class WTFOresConfig {
	...
	public static void customConfig() {
		...
		String genCoal = config.get("Vanilla Ores", "Vanilla Coal Generation", "oreBlock=minecraft:coal_ore,useTexture=coal_ore,genType=1,v1=6,v2=6,maxHeightPercent=110,minPerChunk=60,maxPerChunk=140").getString();
		...
		if (Loader.isModLoaded("TConstruct")) {
			String tconDefault = "oreBlock=TConstruct:SearedBrick,metadata=5,useTexture=aluminum_ore,genType=2,maxHeightPercent=75,minPerChunk=50,v1=10,overrideTexture=ore_aluminum;oreBlock=TConstruct:SearedBrick,metadata=3,useTexture=copper_ore,genType=3,maxHeightPerent=90,minPerChunk=65,v1=10,overrideTexture=ore_copper;oreBlock=TConstruct:SearedBrick,metadata=4,useTexture=tin_ore,genType=1,maxHeightPercent=110,minPerChunk=60,maxPerChunk=90,v1=3,v2=3,overrideTexture=ore_tin";
		...
		if (Loader.isModLoaded("WTFTweaks")) {
			String wtftweaksDefault = "oreBlock=WTFTweaks:nitre_ore,metadata=0,useTexture=nitre_ore,genType=7,maxHeightPercent=90,minPerChunk=70,stone=stone";
		...
		String fullOreString = config.get("Ubified, Fracturing, Variable Density Ores", "Add Your custom ores here", "").getString();
		if (fullOreString != "") {
